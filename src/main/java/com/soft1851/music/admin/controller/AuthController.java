...
public class AuthController {
    ...
    public void getUser(@RequestParam("code") String code) {
        ...
        try {
            ...
            list.add(new BasicNameValuePair("client_id", "9efef0e723337971a918"));
            list.add(new BasicNameValuePair("client_secret", "001a5876320b763b3751dd6311052d5c8da04228"));
            ...
            response.sendRedirect("http://localhost:9090/#/auth?user=" + user);
//            response.sendRedirect("http://localhost:8088/#/auth?uId=" + JSONObject.parseObject(user).getString("id"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
